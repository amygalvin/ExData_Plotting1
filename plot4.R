...
with(mydata2, {
	...
	plot(mydata2$DateTime2, mydata2$Voltage, type="l",
	...
	plot(mydata2$DateTime2, mydata2$Sub_metering_1 , col = "black", type = "l",
		...
		legend("topright", col=c("black", "red", "blue"), legend=c("Sub_metering_1",
 		"Sub_metering_2", "Sub_metering_3"), lty=c(1,1), cex=0.7, bty="n")
	plot(mydata2$DateTime2,mydata2$Global_reactive_power, type="l",
